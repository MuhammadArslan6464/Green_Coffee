...
<div class="main">
    ...
    <section class="container">
        <div class="box-container">
            <div class="box">
                <img src="./img/about-us.jpg" alt="" width="110%">
            </div>
            <div class="box">
                <img src="./img/download.png" alt="">
                <span>Healthy Tea</span>
                <h1>save up to 50% off</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum error veritatis, dolorum saepe ducimus perferendis.</p>
            </div>
        </div>
    </section>
    <section class="shop">
        ...
        <div class="row">
            <img src="./img/about.jpg" alt="" width="19%">
            <div class="row-detail">
                <img src="./img/basil.jpg" alt="" style="margin-left: 20px; width: 95%;">
    ...
    <section class="shop-category">
        <div class="box-container">
            <div class="box">
                <img src="./img/6.jpg" alt="" width="93%">
                <div class="detail">
            ...
            <div class="box">
                <img src="./img/7.jpg" alt="" width="93%">
                <div class="detail">
